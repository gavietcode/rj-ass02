...
import TopRateCard from "../../components/topRate/TopRateCard";
...
const TopRate = () => {
  ...
  return (
    <div className="topRate-movies">
      <h1 className="max-width movie-title">Xếp hạng cao</h1>
      <div
        className="topRate max-width"
